...
import HERO_IMG from "@/assets/level-medio.jpg";

export const Route = createFileRoute("/ensino/medio")({
  head: () => ({
    meta: [
      { title: "Ensino Médio — Colégio RS" },
      { name: "description", content: "Preparação ENEM e projeto de vida da 1ª à 3ª série." },
      { property: "og:title", content: "Ensino Médio — Colégio RS" },
      { property: "og:description", content: "Preparação ENEM e projeto de vida da 1ª à 3ª série." },
...
function Page() {
  return (
    <>
      <PageHero eyebrow="Ensino" title="Ensino Médio" subtitle="Preparação ENEM e projeto de vida da 1ª à 3ª série." tone="sky" />
      <section className="bg-background py-20">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 md:grid-cols-2 md:px-10">
          <img src={HERO_IMG} alt="Ensino Médio" loading="lazy" width={1024} height={768} className="aspect-[4/3] w-full rounded-3xl object-cover shadow-soft" />
          <div>
