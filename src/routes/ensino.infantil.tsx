...
import HERO_IMG from "@/assets/level-infantil.jpg";

export const Route = createFileRoute("/ensino/infantil")({
  head: () => ({
    meta: [
      { title: "Educação Infantil — Colégio RS" },
      { name: "description", content: "Acolhimento, ludicidade e descobertas a partir dos 4 anos." },
      { property: "og:title", content: "Educação Infantil — Colégio RS" },
      { property: "og:description", content: "Acolhimento, ludicidade e descobertas a partir dos 4 anos." },
      ...
      <section className="bg-background py-20">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 md:grid-cols-2 md:px-10">
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">A Educação Infantil é o tempo do brincar, do criar, do imaginar. Nossas turmas equilibram afeto, rotina e estímulos pedagógicos.</p>
